...
export function ValuesModule({ media }: { media?: Record<string, LMUInstructionalMedia> }) {
  ...
  function finish() { completeValues(response); router.push("/experiences/life-mapping-u/original/modules"); }
