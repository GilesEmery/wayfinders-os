...
function PreferencePeopleModule({ media, variant }: { media?: Record<string, LMUInstructionalMedia>; variant: "teammates" | "supervisor" }) {
  ...
  function finish() { if (isSupervisor) completeSupervisor(readSupervisorResponse()); else completeTeammates(readTeammatesResponse()); router.push("/experiences/life-mapping-u/original/modules"); }
  ...
  return <LMUShell context={moduleTitle} theme="dark" journeyHref="/experiences/life-mapping-u/original/modules" onInternalBack={screen === "introduction" ? undefined : sectionBack}>
