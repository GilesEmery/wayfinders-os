...
export const growthDefinition: LMUModuleDefinition = {
  ...
  instructionalMedia: { intro: { provider: "youtube", videoId: "J0IMdVwiohc", title: "Growth instructional video", description: "Identify where you are ready to learn, develop, and stretch." } },
