...
export async function reorderCurriculumAction(experienceId: string, versionId: string, kind: "module" | "lesson" | "section", itemId: string, sectionId: string | undefined, direction: "up" | "down") { await run(experienceId, versionId, () => reorderItem(experienceId, versionId, kind, itemId, direction), "Order saved.", sectionId); }
